<template>
    <div class="w-full h-[4.5rem] rounded-b-lg px-4 bg-[--card-bg] flex items-center justify-between">
        <a class="h-12 hover:bg-blue-100 px-6 rounded-lg flex items-center" href="/">
            <span></span>
